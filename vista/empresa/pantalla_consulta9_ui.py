...
"}")
        ...
        self.label_6.setPixmap(QPixmap(u"vista/empresa/recursos/usuario.png"))
...
"}")
        icon6 = QIcon()
        icon6.addFile(u"recursos/recursos_empresa/volver.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.QtableWidget_corridas.setGeometry(QRect(315, 360, 1050, 551))
