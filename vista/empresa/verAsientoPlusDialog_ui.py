...
class VerAsientoPlus(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.label_titulo.setStyleSheet("font-size: 28pt; font-weight: bold; color: #1877F2;") 
        self.label_titulo.setAlignment(Qt.AlignCenter)
        self.label_titulo.setText("Ver Asientos - Plus")
        ...
        self.frame_asientos.setGeometry(QRect(120, 340, 410, 530))
        ...
        # CREAR 44 BOTONES DE ASIENTOS (PLUS) - TODOS DESHABILITADOS PARA SELECCIÓN
        self.asientos = []
        asiento_ids = [
        ...
        self.frame_botones.setGeometry(QRect(225, 880, 200, 60))
