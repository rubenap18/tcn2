...
"}")
        ...
        self.label_imagenes_noticias.setPixmap(QPixmap(u"../recursos/recursos usuario/carretera-escenica-palya-saldamando-1024x768.jpg"))
        ...
        self.label_imagen_eventos.setPixmap(QPixmap(u"../recursos/recursos usuario/provino-1-1-1200x783.jpg"))
        ...
        self.label_imagen_rutas.setPixmap(QPixmap(u"../recursos/recursos usuario/ensenada_2.jpg"))
        ...
        self.label_imagen_destinos.setPixmap(QPixmap(u"../recursos/recursos usuario/tecate_2.jpg"))
        ...
        self.label_imagen_consejos.setPixmap(QPixmap(u"../recursos/recursos usuario/viajar-en-autobus-busolinea.jpg"))
