...
class Ui_pagina_contactanos(object):
    def setupUi(self, pagina_contactanos):
        ...
        self.logo_label.setPixmap(QPixmap(u"../recursos/recursos usuario/LOGOJPG.jpg"))
...
"}")
        ...
        self.label_17.setPixmap(QPixmap(u"../recursos/recursos usuario/facebook.png"))
        ...
        self.label_18.setPixmap(QPixmap(u"../recursos/recursos usuario/gmail.png"))
        self.label_18.setScaledContents(True)
        self.label_16 = QLabel(pagina_contactanos)
        self.label_16.setObjectName(u"label_16")
        self.label_16.setGeometry(QRect(100, 365, 71, 71))
        self.label_16.setPixmap(QPixmap(u"../recursos/recursos usuario/instagram.png"))
        ...
        self.label_15.setPixmap(QPixmap(u"../recursos/recursos usuario/irizar i6 naranja.png"))
        ...
        self.label_19.setPixmap(QPixmap(u"../recursos/recursos usuario/whatsapp.png"))
